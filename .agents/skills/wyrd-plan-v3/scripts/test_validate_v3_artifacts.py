...
class Fixtures(unittest.TestCase):
    ...
    def test_rejects_invalid_proof_identity_and_prerequisite(self)->None:
        """Keep proof ordering distinct, task-local, and source bound."""
        proof=self.data["tasks"][0]["proofs"][0]
        proof["id"]="P1"; proof["requires_integrated"]=["T1"]
        self.write(); self.assert_error("invalid proof id"); self.assert_error("invalid proof prerequisites")
