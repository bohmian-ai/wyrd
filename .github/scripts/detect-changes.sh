...
set_output rust '^(Cargo\.toml|Cargo\.lock|rust-toolchain\.toml|deny\.toml|mise\.toml|crates/|sdks/wyrd-sdk-rust/|sdks/wyrd-sdk-python/Cargo\.toml|sdks/wyrd-sdk-python/src/)'
