...
Review `task-review-01` returned `FIX_REQUIRED` with seven findings. They are
closed by `changes/active/oracle-local-admission/review/task-review-01/ORACLE-LOCAL-T01-R1-close-admission-gaps.md`,
whose own evidence section records the AC-R1-001..007 acceptance matrix, every
exact named command re-run, and the lane results for the cumulative candidate
`d3888ddae..648e152e7`.
