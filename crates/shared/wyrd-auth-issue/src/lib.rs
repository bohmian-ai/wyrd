...
impl IssuingKey {
    ...
    pub fn issue_delegated_access_token(
        ...
        requested_subject: PrincipalRef,
...
fn validate_principal_ref(principal: &PrincipalRef) -> Result<(), IssueError> {
    match (
        principal.kind,
...
mod tests {
    ...
    fn user_principal() -> PrincipalRef {
        PrincipalRef {
    ...
    fn service_principal() -> PrincipalRef {
        PrincipalRef {
