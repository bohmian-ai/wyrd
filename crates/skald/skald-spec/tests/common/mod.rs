...
pub fn openai_chat_response() -> OpenAiChatResponse {
    typed(json!({
        "id": "chatcmpl_123",
...
pub fn openai_responses_request() -> OpenAiResponsesRequest {
    typed(json!({
        "model": "gpt-4o",
        "input": [
...
pub fn openai_responses_response() -> OpenAiResponsesResponse {
    typed(json!({
        "id": "resp_123",
        "object": "response",
        "model": "gpt-4o",
...
pub fn anthropic_request() -> AnthropicMessagesRequest {
    typed(json!({
...
pub fn anthropic_response(stop_reason: AnthropicStopReason) -> AnthropicMessagesResponse {
...
pub fn google_request() -> GoogleGenerateContentRequest {
    typed(json!({
        "contents": [{
            "role": "user",
            "parts": [
...
pub fn google_response(finish_reason: GoogleFinishReason) -> GoogleGenerateContentResponse {
...
pub fn vertex_generate_request() -> VertexGenerateContentRequest {
    VertexGenerateContentRequest(google_request())
}

pub fn vertex_predict_request() -> VertexPredictRequest {
    typed(json!({
...
pub fn vertex_predict_response() -> VertexPredictResponse {
    typed(json!({
...
pub fn openai_message() -> OpenAiChatMessage {
    typed(json!({
        "role": "assistant",
...
pub fn anthropic_message() -> AnthropicMessage {
    typed(json!({
        "role": "assistant",
        "content": [
...
pub fn google_message() -> GoogleContent {
    typed(json!({
        "role": "model",
        "parts": [
            {"text": "hello"},
...
pub fn provider_request_variants() -> Vec<ProviderRequest> {
    vec![
...
pub fn provider_response_variants() -> Vec<ProviderResponse> {
    vec![
