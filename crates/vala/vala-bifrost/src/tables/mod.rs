...
mod fingerprint_drift {
    ...
    const GENAI_MESSAGES: [u8; 32] = [
        ...
        91, 111, 103, 88, 208, 244, 127, 127, 240, 34, 132, 114, 199,
    ];
    const GENAI_EMBEDDINGS: [u8; 32] = [
        45, 216, 13, 157, 12, 80, 145, 71, 135, 101, 13, 192, 2, 216, 137, 161, 160, 102, 133, 202,
        221, 145, 64, 133, 40, 47, 86, 56, 99, 223, 166, 46,
    ];
    const GENAI_TOOL_CALLS: [u8; 32] = [
        117, 172, 57, 105, 217, 98, 35, 70, 48, 175, 200, 245, 206, 133, 74, 29, 76, 180, 11, 195,
        188, 97, 229, 249, 77, 232, 247, 24, 128, 66, 234, 180,
    ];
    const GENAI_MEMORY: [u8; 32] = [
        54, 247, 17, 97, 47, 52, 152, 212, 145, 213, 54, 128, 213, 8, 87, 137, 166, 120, 42, 31,
    ...
    const EVAL_RUNS: [u8; 32] = [
        ...
        85, 41, 13, 56, 180, 255, 77, 97, 58, 225, 248, 162, 143,
    ];
    ...
    const DEV_AGENT_TRACES: [u8; 32] = [
        64, 86, 240, 168, 210, 55, 159, 58, 161, 230, 11, 29, 95, 84, 160, 184, 112, 58, 38, 148,
        87, 102, 19, 225, 96, 153, 138, 184, 126, 9, 184, 222,
    ];
    ...
    fn genai_messages_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("response_finish_reasons", DataType::Utf8, true),
            Field::new(
            ...
            Field::new("request_stop_sequences", DataType::Utf8, true),
            Field::new("request_stream", DataType::Boolean, true),
            Field::new("request_encoding_formats", DataType::Utf8, true),
            ...
            Field::new("input_messages", DataType::Utf8, true),
            Field::new("output_messages", DataType::Utf8, true),
            Field::new("system_instructions", DataType::Utf8, true),
            ...
            Field::new("eval_results", DataType::Utf8, true),
    ...
    fn genai_tool_calls_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("tool_call_arguments", DataType::Utf8, true),
            Field::new("tool_call_result", DataType::Utf8, true),
    ...
    fn genai_memory_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("memory_records", DataType::Utf8, true),
            Field::new("error_type", DataType::Utf8, true),
            Field::new("extra", DataType::Utf8, true),
            Field::new("run_id", DataType::Utf8, true),
            Field::new("card_uid", DataType::Utf8, true),
    ...
    fn metrics_points_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("positive_buckets", DataType::Utf8, true),
            Field::new("negative_buckets", DataType::Utf8, true),
            Field::new("quantile_values", DataType::Utf8, true),
    ...
    fn eval_runs_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("execution_plan", DataType::Utf8, true),
            Field::new("run_id", DataType::Utf8, true),
            Field::new("card_uid", DataType::Utf8, true),
            Field::new("principal_id", DataType::Utf8, true),
            Field::new(
    ...
    fn dev_agent_traces_full() -> Schema {
        Schema::new(vec![
            ...
            Field::new("tool_io", DataType::Utf8, true),
            Field::new(
                "started_at",
                DataType::Timestamp(TimeUnit::Microsecond, Some("UTC".into())),
                false,
