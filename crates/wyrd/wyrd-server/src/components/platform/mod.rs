...
//!
//! `credentials` administers the secrets that authenticate a platform
//! principal, so the deployment root can be rotated through Wyrd rather than
...
pub use credentials::platform_credentials_router;
