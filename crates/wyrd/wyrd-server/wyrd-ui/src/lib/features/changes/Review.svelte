...
<div class="columns review"><div class="stack">
  ...
  <section id="submit-review"><Panel title={`Submit review — revision ${change.revisionNumber}`} variant="raised">
