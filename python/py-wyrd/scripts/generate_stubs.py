"""Generate checked-in Python stubs for the Wyrd Python package."""
...
PACKAGE = ROOT / "python" / "wyrd"


DATA_PYI = '''from __future__ import annotations
...
INIT_PYI = """from . import data as data
from .data import (
    ArrowInterface as ArrowInterface,
)
from .data import (
    CustomDataInterface as CustomDataInterface,
)
from .data import (
    DataCard as DataCard,
)
from .data import (
    DataInterface as DataInterface,
)
from .data import (
    DataSchema as DataSchema,
)
from .data import (
    DataStats as DataStats,
)
from .data import (
    FieldSpec as FieldSpec,
)
from .data import (
    HuggingfaceInterface as HuggingfaceInterface,
)
from .data import (
    ImageInterface as ImageInterface,
)
from .data import (
    JsonlInterface as JsonlInterface,
)
from .data import (
    NumpyInterface as NumpyInterface,
)
from .data import (
    PandasInterface as PandasInterface,
)
from .data import (
    ParquetInterface as ParquetInterface,
)
from .data import (
    PolarsInterface as PolarsInterface,
)
from .data import (
    Split as Split,
)
from .data import (
    SqlInterface as SqlInterface,
)
from .data import (
    TextInterface as TextInterface,
)
from .data import (
    TorchInterface as TorchInterface,
)
from .data import (
    WyrdError as WyrdError,
)
...
NATIVE_PYI = """def native_module_ready() -> bool: ...
"""


def main() -> None:
    PACKAGE.mkdir(parents=True, exist_ok=True)
    (PACKAGE / "data.pyi").write_text(DATA_PYI, encoding="utf-8")
    (PACKAGE / "__init__.pyi").write_text(INIT_PYI, encoding="utf-8")
    (PACKAGE / "_native.pyi").write_text(NATIVE_PYI, encoding="utf-8")
    subprocess.run(
        [
            "uv",
            "run",
            "ruff",
            "format",
            str(PACKAGE / "data.pyi"),
            str(PACKAGE / "__init__.pyi"),
            str(PACKAGE / "_native.pyi"),
        ],
        check=True,
    )
    subprocess.run(
